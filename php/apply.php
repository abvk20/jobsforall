...
$sql = "SELECT * FROM jobseeker WHERE mobile = $num";
...
$msg = "$name we are delighted to inform you that we have forwarded your profile to $org as per your request. \nYou will further be reverted if the your profile seems suitable.";
...
mail("$email","$name WE HAVE FORWARDED YOUR JOB PROFILE TO $org",$msg);
...
<html>
		        ...
		        <div class="navbar navbar-default navbar-static-top">
		            <div class="container">
		              ...
		              <a href="#">HOME</a>
		                        ...
		                        <li>
		                            <a href="../html/trial_pro_seek.php">Profile<br></a>
		                        </li>
		...
		<h3><?php echo "Great You just Applied for $org!!!!"; ?></h3>
